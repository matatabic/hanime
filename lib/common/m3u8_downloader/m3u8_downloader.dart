...
class M3u8Downloader {
  ...
  ///
  /// - [onSelect] 点击通知的回调
  static Future<bool> initialize({SelectNotificationCallback? onSelect}) async {
    assert(
        !_initialized, 'M3u8Downloader.initialize() must be called only once!');
  ...
  static Future<bool> delete(String url) async {
    ...
    return await _channel.invokeMethod("delete", {"url": url}) ?? false;
  }
