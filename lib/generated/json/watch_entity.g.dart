...
WatchEntity $WatchEntityFromJson(Map<String, dynamic> json) {
	...
	final WatchVideoData? videoData = jsonConvert.convert<WatchVideoData>(json['videoData']);
	if (videoData != null) {
		watchEntity.videoData = videoData;
	}
	final List<WatchEpisode>? episode = jsonConvert.convertListNotNull<WatchEpisode>(json['episode']);
	if (episode != null) {
		watchEntity.episode = episode;
	}
	final List<WatchTag>? tag = jsonConvert.convertListNotNull<WatchTag>(json['tag']);
	if (tag != null) {
		watchEntity.tag = tag;
	}
	...
	final List<WatchCommend>? commend = jsonConvert.convertListNotNull<WatchCommend>(json['commend']);
	if (commend != null) {
...
WatchVideoData $WatchVideoDataFromJson(Map<String, dynamic> json) {
	...
	final List<WatchVideoDataVideo>? video = jsonConvert.convertListNotNull<WatchVideoDataVideo>(json['video']);
	if (video != null) {
...
WatchVideoDataVideo $WatchVideoDataVideoFromJson(Map<String, dynamic> json) {
	...
	final List<WatchVideoDataVideoList>? list = jsonConvert.convertListNotNull<WatchVideoDataVideoList>(json['list']);
	if (list != null) {
...
WatchVideoDataVideoList $WatchVideoDataVideoListFromJson(Map<String, dynamic> json) {
	final WatchVideoDataVideoList watchVideoDataVideoList = WatchVideoDataVideoList();
	final String? name = jsonConvert.convert<String>(json['name']);
	if (name != null) {
...
Map<String, dynamic> $WatchVideoDataVideoListToJson(WatchVideoDataVideoList entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['name'] = entity.name;
	data['url'] = entity.url;
	return data;
