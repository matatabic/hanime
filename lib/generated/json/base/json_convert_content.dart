  ...
  //list is returned by type
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		if(<DownloadEntity>[] is M){
			return data.map<DownloadEntity>((Map<String, dynamic> e) => DownloadEntity.fromJson(e)).toList() as M;
		}
		if(<FavouriteEntity>[] is M){
			return data.map<FavouriteEntity>((Map<String, dynamic> e) => FavouriteEntity.fromJson(e)).toList() as M;
		}
		if(<FavouriteChildren>[] is M){
			return data.map<FavouriteChildren>((Map<String, dynamic> e) => FavouriteChildren.fromJson(e)).toList() as M;
		}
		if(<HomeEntity>[] is M){
			return data.map<HomeEntity>((Map<String, dynamic> e) => HomeEntity.fromJson(e)).toList() as M;
		}
		if(<HomeSwiper>[] is M){
			return data.map<HomeSwiper>((Map<String, dynamic> e) => HomeSwiper.fromJson(e)).toList() as M;
		}
		if(<HomeTop>[] is M){
			return data.map<HomeTop>((Map<String, dynamic> e) => HomeTop.fromJson(e)).toList() as M;
		}
		if(<HomeTopVideo>[] is M){
			return data.map<HomeTopVideo>((Map<String, dynamic> e) => HomeTopVideo.fromJson(e)).toList() as M;
		}
		if(<HomeLatest>[] is M){
			return data.map<HomeLatest>((Map<String, dynamic> e) => HomeLatest.fromJson(e)).toList() as M;
		}
		if(<HomeLatestVideo>[] is M){
			return data.map<HomeLatestVideo>((Map<String, dynamic> e) => HomeLatestVideo.fromJson(e)).toList() as M;
		}
		if(<HomeFire>[] is M){
			return data.map<HomeFire>((Map<String, dynamic> e) => HomeFire.fromJson(e)).toList() as M;
		}
		if(<HomeFireVideo>[] is M){
			return data.map<HomeFireVideo>((Map<String, dynamic> e) => HomeFireVideo.fromJson(e)).toList() as M;
		}
		if(<HomeTag>[] is M){
			return data.map<HomeTag>((Map<String, dynamic> e) => HomeTag.fromJson(e)).toList() as M;
		}
		if(<HomeTagVideo>[] is M){
			return data.map<HomeTagVideo>((Map<String, dynamic> e) => HomeTagVideo.fromJson(e)).toList() as M;
		}
		if(<HomeHot>[] is M){
			return data.map<HomeHot>((Map<String, dynamic> e) => HomeHot.fromJson(e)).toList() as M;
		}
		if(<HomeHotVideo>[] is M){
			return data.map<HomeHotVideo>((Map<String, dynamic> e) => HomeHotVideo.fromJson(e)).toList() as M;
		}
		if(<HomeWatch>[] is M){
			return data.map<HomeWatch>((Map<String, dynamic> e) => HomeWatch.fromJson(e)).toList() as M;
		}
		if(<HomeWatchVideo>[] is M){
			return data.map<HomeWatchVideo>((Map<String, dynamic> e) => HomeWatchVideo.fromJson(e)).toList() as M;
		}
		if(<SearchEntity>[] is M){
			return data.map<SearchEntity>((Map<String, dynamic> e) => SearchEntity.fromJson(e)).toList() as M;
		}
		if(<SearchGenre>[] is M){
			return data.map<SearchGenre>((Map<String, dynamic> e) => SearchGenre.fromJson(e)).toList() as M;
		}
		if(<SearchTag>[] is M){
			return data.map<SearchTag>((Map<String, dynamic> e) => SearchTag.fromJson(e)).toList() as M;
		}
		if(<SearchTagData>[] is M){
			return data.map<SearchTagData>((Map<String, dynamic> e) => SearchTagData.fromJson(e)).toList() as M;
		}
		if(<SearchBrand>[] is M){
			return data.map<SearchBrand>((Map<String, dynamic> e) => SearchBrand.fromJson(e)).toList() as M;
		}
		if(<SearchSort>[] is M){
			return data.map<SearchSort>((Map<String, dynamic> e) => SearchSort.fromJson(e)).toList() as M;
		}
		if(<SearchDate>[] is M){
			return data.map<SearchDate>((Map<String, dynamic> e) => SearchDate.fromJson(e)).toList() as M;
		}
		if(<SearchDateData>[] is M){
			return data.map<SearchDateData>((Map<String, dynamic> e) => SearchDateData.fromJson(e)).toList() as M;
		}
		if(<SearchDuration>[] is M){
			return data.map<SearchDuration>((Map<String, dynamic> e) => SearchDuration.fromJson(e)).toList() as M;
		}
		if(<SearchVideo>[] is M){
			return data.map<SearchVideo>((Map<String, dynamic> e) => SearchVideo.fromJson(e)).toList() as M;
		}
		if(<WatchEntity>[] is M){
			return data.map<WatchEntity>((Map<String, dynamic> e) => WatchEntity.fromJson(e)).toList() as M;
		}
		if(<WatchInfo>[] is M){
			return data.map<WatchInfo>((Map<String, dynamic> e) => WatchInfo.fromJson(e)).toList() as M;
		}
		if(<WatchVideoData>[] is M){
			return data.map<WatchVideoData>((Map<String, dynamic> e) => WatchVideoData.fromJson(e)).toList() as M;
		}
		if(<WatchVideoDataVideo>[] is M){
			return data.map<WatchVideoDataVideo>((Map<String, dynamic> e) => WatchVideoDataVideo.fromJson(e)).toList() as M;
		}
		if(<WatchVideoDataVideoList>[] is M){
			return data.map<WatchVideoDataVideoList>((Map<String, dynamic> e) => WatchVideoDataVideoList.fromJson(e)).toList() as M;
		}
		if(<WatchEpisode>[] is M){
			return data.map<WatchEpisode>((Map<String, dynamic> e) => WatchEpisode.fromJson(e)).toList() as M;
		}
		if(<WatchTag>[] is M){
			return data.map<WatchTag>((Map<String, dynamic> e) => WatchTag.fromJson(e)).toList() as M;
		}
		if(<WatchCommend>[] is M){
			return data.map<WatchCommend>((Map<String, dynamic> e) => WatchCommend.fromJson(e)).toList() as M;
		}
